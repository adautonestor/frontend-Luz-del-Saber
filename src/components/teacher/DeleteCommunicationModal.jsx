 ...
 */
const DeleteCommunicationModal = ({ isOpen, onClose, onConfirm, communication }) => {
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p>Esta acción no se puede deshacer. El comunicado será eliminado permanentemente.</p>
              </div>
            </div>
          </div>
